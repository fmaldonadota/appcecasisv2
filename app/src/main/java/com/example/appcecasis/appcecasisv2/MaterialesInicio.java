...
public class MaterialesInicio extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materiales_inicio);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentReg = new Intent(MaterialesInicio.this, MaterialesBusqueda.class);
                MaterialesInicio.this.startActivity(intentReg);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.materiales_inicio, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            Intent intentReg = new Intent(MaterialesInicio.this, InicioNoticias.class);
            MaterialesInicio.this.startActivity(intentReg);
        } else if (id == R.id.nav_gallery) {

            Intent intentReg = new Intent(MaterialesInicio.this, LaboratorioInicio.class);
            MaterialesInicio.this.startActivity(intentReg);

        } else if (id == R.id.nav_slideshow) {

            Intent intentReg = new Intent(MaterialesInicio.this, MaterialesInicio.class);
            MaterialesInicio.this.startActivity(intentReg);
            ...
            Intent intentReg = new Intent(MaterialesInicio.this, MantenimientoInicio.class);
            MaterialesInicio.this.startActivity(intentReg);
            ...
            Intent intentReg = new Intent(MaterialesInicio.this,MainActivity.class);
            MaterialesInicio.this.startActivity(intentReg);
